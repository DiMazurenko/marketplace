...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _typeof(obj) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && \"function\" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }, _typeof(obj); }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _toPropertyKey(arg) { var key = _toPrimitive(arg, \"string\"); return _typeof(key) === \"symbol\" ? key : String(key); }\nfunction _toPrimitive(input, hint) { if (_typeof(input) !== \"object\" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || \"default\"); if (_typeof(res) !== \"object\") return res; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (hint === \"string\" ? String : Number)(input); }\nvar Accordion = /*#__PURE__*/function () {\n  function Accordion() {\n    _classCallCheck(this, Accordion);\n    this.cards = document.querySelectorAll('[data-accordion]');\n    this.activeClass = '_active';\n    this.init();\n  }\n  _createClass(Accordion, [{\n    key: \"init\",\n    value: function init() {\n      var _this = this;\n      this.cards.forEach(function (card) {\n        _this.initCard(card);\n      });\n      window.addEventListener('resize', function () {\n        _this.cards.forEach(function (card) {\n          _this.updateCardHeightConst(card);\n        });\n      });\n    }\n  }, {\n    key: \"initCard\",\n    value: function initCard(card) {\n      var _this2 = this;\n      this.updateCardHeightConst(card);\n      var btn = card.querySelector('[data-accordion-btn]');\n      if (!btn) {\n        return;\n      }\n      btn.addEventListener('click', function () {\n        var isActive = _this2.isActiveCard(card);\n        if (isActive) {\n          _this2.closeCard(card);\n          return;\n        }\n        _this2.openCard(card);\n      });\n    }\n  }, {\n    key: \"isActiveCard\",\n    value: function isActiveCard(card) {\n      return card.classList.contains(this.activeClass);\n    }\n  }, {\n    key: \"openCard\",\n    value: function openCard(card) {\n      card.classList.add(this.activeClass);\n    }\n  }, {\n    key: \"closeCard\",\n    value: function closeCard(card) {\n      card.classList.remove(this.activeClass);\n    }\n  }, {\n    key: \"updateCardHeightConst\",\n    value: function updateCardHeightConst(card) {\n      var isActive = this.isActiveCard(card);\n      this.openCard(card);\n      card.classList.remove('_init');\n      var content = card.querySelector('[data-accordion-content]');\n      card.style.setProperty('--height', \"\");\n      card.style.setProperty('--height', \"\".concat(content.offsetHeight, \"px\"));\n      setTimeout(function () {\n        card.classList.add('_init');\n      }, 100);\n      if (!isActive) {\n        this.closeCard(card);\n      }\n    }\n  }]);\n  return Accordion;\n}();\n/* harmony default export */ __webpack_exports__[\"default\"] = (new Accordion());\n\n//# sourceURL=webpack:///./src/assets/js/modules/accordions.js?");

/***/ }),

/***/ 7:
/*!********************************************************************************************!*\
  !*** multi ./src/assets/js/decree.js webpack-hot-middleware/client?quiet=true&noInfo=true ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! ./src/assets/js/decree.js */\"./src/assets/js/decree.js\");\nmodule.exports = __webpack_require__(/*! webpack-hot-middleware/client?quiet=true&noInfo=true */\"./node_modules/webpack-hot-middleware/client.js?quiet=true&noInfo=true\");\n\n\n//# sourceURL=webpack:///multi_./src/assets/js/decree.js_webpack-hot-middleware/client?");
